...
if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
	require_once('ic-job-function.php');

if ( ! class_exists( 'ic_job_addons' ) ) {
	class ic_job_addons extends icjm_job_function{
		private $token;
		...
		public $plugin_key  =   "icjm_add_ons_page";
			...
			<div class="ic_plugins_container">
				<div class="row">
					<div class="col-md-4">
						<div class="ic_other_plugins">
							<div class="ic_plugin_img">
								<img src="<?php echo $this->constants['plugin_url']?>/wp-job-pro/images/golden_report.jpg" alt="WooCommerce Advance Sales Report (Gold Version)" />
							</div>
					...
					<div class="col-md-4">
						<div class="ic_other_plugins">
							<div class="ic_plugin_img">
								<img src="<?php echo $this->constants['plugin_url']?>/wp-job-pro/images/premium-gold-report.jpg" alt="WooCommerce Advance Sales Report (Premium Gold Version)">
							</div>
					...
					<div class="col-md-4">
						<div class="ic_other_plugins">
							<div class="ic_plugin_img">
								<img src="<?php echo $this->constants['plugin_url']?>/wp-job-pro/images/enterprise_edition.jpg" alt="WooCommerce Advance Sales Report (Enterprise Edition)" />
							</div>
							<div class="ic_plugin_content">
					...
					<div class="col-md-4">
						<div class="ic_other_plugins">
							<div class="ic_plugin_img">
								<img src="<?php echo $this->constants['plugin_url']?>/wp-job-pro/images/inventory.jpg" alt="WooCommerce Inventory Plugin" />
							</div>
					...
					<div class="col-md-4">
						<div class="ic_other_plugins">
							<div class="ic_plugin_img">
								<img src="<?php echo $this->constants['plugin_url']?>/wp-job-pro/images/job-manager.jpg" alt="WooCommerce Job Manager" />
							</div>
					...
					<div class="col-md-4">
						<div class="ic_other_plugins">
							<div class="ic_plugin_img">
								<img src="<?php echo $this->constants['plugin_url']?>/wp-job-pro/images/subscription.jpg" alt="WooCommerce Subscription" />
							</div>
					...
					<div class="col-md-4">
						<div class="ic_other_plugins">
							<div class="ic_plugin_img">
								<img src="<?php echo $this->constants['plugin_url']?>/wp-job-pro/images/sales_trends_analysis.jpg" alt="WooCommerce Sales Trends Analysis" />
							</div>
					...
					<div class="col-md-4">
						<div class="ic_other_plugins">
							<div class="ic_plugin_img">
								<img src="<?php echo $this->constants['plugin_url']?>/wp-job-pro/images/audit-log-pro.jpg" alt="WooCommerce Audit Log Pro" />
							</div>
